...
const (
	...
	ProductService_GetBrands_FullMethodName           = "/product.ProductService/GetBrands"
	ProductService_GetProductStats_FullMethodName     = "/product.ProductService/GetProductStats"
...
type ProductServiceClient interface {
	...
	GetLowStockProducts(ctx context.Context, in *GetLowStockRequest, opts ...grpc.CallOption) (*ListProductsResponse, error)
...
func (c *productServiceClient) GetLowStockProducts(ctx context.Context, in *GetLowStockRequest, opts ...grpc.CallOption) (*ListProductsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListProductsResponse)
	err := c.cc.Invoke(ctx, ProductService_GetLowStockProducts_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *productServiceClient) GetProductStats(ctx context.Context, in *GetProductStatsRequest, opts ...grpc.CallOption) (*GetProductStatsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *productServiceClient) BulkDeleteProducts(ctx context.Context, in *BulkDeleteProductsRequest, opts ...grpc.CallOption) (*BulkDeleteProductsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type ProductServiceServer interface {
	...
	GetLowStockProducts(context.Context, *GetLowStockRequest) (*ListProductsResponse, error)
...
func (UnimplementedProductServiceServer) GetLowStockProducts(context.Context, *GetLowStockRequest) (*ListProductsResponse, error) {
...
func (UnimplementedProductServiceServer) GetProductStats(context.Context, *GetProductStatsRequest) (*GetProductStatsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetProductStats not implemented")
}
func (UnimplementedProductServiceServer) BulkDeleteProducts(context.Context, *BulkDeleteProductsRequest) (*BulkDeleteProductsResponse, error) {
...
func _ProductService_GetLowStockProducts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).GetLowStockProducts(ctx, req.(*GetLowStockRequest))
	}
	return interceptor(ctx, in, info, handler)
}
